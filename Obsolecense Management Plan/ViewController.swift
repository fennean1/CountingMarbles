...
class ViewController: UIViewController {
    ...
    @IBAction func help(sender: UIButton){
        ...
        if Help.dropped == false
        {
        
            Help.drop(UIImage(named: "HelpScene")!)
        }
        else if Help.dropped == true
        {
            Help.putback()
        }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        addBtn.addTarget(self, action: #selector(ViewController.addBall(sender:)), for: .touchUpInside)
        subBtn.addTarget(self, action: #selector(ViewController.subBall(sender:)), for: .touchUpInside)
